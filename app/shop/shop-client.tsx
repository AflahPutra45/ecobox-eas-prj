...
// Hanya bagian interaktif (filter + grid) yang jadi client component
...
export function ShopClientSection() {
      ...
      <div className="mt-8 flex gap-8">
        ...
        >
          ...
          <div className="mt-6 space-y-8 lg:mt-0">
            {/* Categories */}
            <div>
              <h3 className="mb-4 text-sm font-semibold text-foreground">Kategori</h3>
            ...
            <div>
              <h3 className="mb-4 text-sm font-semibold text-foreground">Badge Keberlanjutan</h3>
            ...
            {/* Price Range */}
            <div>
              <h3 className="mb-4 text-sm font-semibold text-foreground">Rentang Harga</h3>
              <Slider
                value={priceRange}
